...
// these are font modifiers that can be used by the user for the font argument of colog
#define CF_NORMAL 0
#define CF_BOLD 1
#define CF_UNDERLINE 4
#define CF_INVERSE 0x8000

// internal codes to represent bright and dim colours
#define CA_NORMAL 30
#define CA_HIGHINT 90
#define CA_BACKGROUND 10

// internal colour codes to represent base colours
#define CC_BLACK  0
#define CC_RED    1
#define CC_GREEN  2
#define CC_YELLOW 3
...
// colour codes that the user can use for the foreground colour of colog
